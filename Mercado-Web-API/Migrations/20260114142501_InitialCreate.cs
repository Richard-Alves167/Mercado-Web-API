        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Preco = table.Column<decimal>(type: "decimal(18,2)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FornecedorProduto", x => new { x.IdFornecedor, x.IdProduto });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdProduto = table.Column<int>(type: "int", nullable: false),
                    Preco = table.Column<decimal>(type: "decimal(18,2)", maxLength: 1000, nullable: false),
                    Quantidade = table.Column<int>(type: "int", maxLength: 99, nullable: false)
                },
                constraints: table =>
                {
